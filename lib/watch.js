...
function watch(opts) {
    ...
    _util2.default.puts(("Command: " + _util2.default.inspect(opts.commandArgs)).cyan);
    _util2.default.puts(("Pattern: " + _util2.default.inspect(opts.patterns)).cyan);
...
function changed(event, filename) {
    if (!_running) {
        ...
        if (event && filename) {
            _util2.default.puts((" " + event + " " + filename).magenta);
        }
